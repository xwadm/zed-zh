...
impl GitGraph {
    ...
    pub fn new(
        ...
        let search_editor = cx.new(|cx| {
            ...
            editor.set_placeholder_text("搜索提交记录…", window, cx);
            editor
        });
                    ...
                    .child(
                        v_flex()
                            ...
                            .child({
                                ...
                                let (icon, icon_color, tooltip_label) = if is_copied {
                                    (IconName::Check, Color::Success, "提交SHA已复制！")
                                } else {
                                    (IconName::Hash, Color::Muted, "复制提交SHA")
                                };
